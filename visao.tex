...
\begin{tabular}{@{}p{0.1\textwidth}p{0.1\textwidth}p{0.5\textwidth}p{0.2\textwidth}@{}}
\toprule
...
\toprule
% descreva o problema
O problema & Esquecer de coisas importantes do cotidiano  \\ \midrule
% informe as partes interessadas afetadas pelo problema
Afeta & usuários que queiram se organizar criando anotações em seu  \textit{smartphone} \\ \midrule
% qual é o impacto desse problema?
Cujo impacto é & esquecer de coisas úteis do cotidiano \\ \midrule
...
Todos & IDE & Android Studio & 4.1.2 & 04  & - \\ \midrule
Todos & SDK & Flutter & 2.0.1 & 04  & - \\ \midrule
Todos & Linguagem de programação & Dart & 2.12.0 & 04  & - \\ \midrule
Todos & Linguagem de programação & Kotlin & 1.4.30 & 04  & - \\ \midrule
Todos & Extensão do Android Studio & Dart & 201.9335 & 04  & - \\ \midrule
Todos & Extensão do Android Studio & Flutter & 54.0.1 & 04  & - \\ \midrule
Todos & Extensão do Android Studio & Kotlin & 1.4.31-release-Studio4.1-1 & 04  & - \\ \midrule
Todos & Pacote Flutter & firebase\_core & 0.7.0 & 04 & - \\ \midrule
Todos & Pacote Flutter & firebase\_auth & 0.20.0+1 & 04  & - \\ \midrule
Todos & Pacote Flutter & provider & 4.3.3 & 04 & - \\ \midrule
Todos & Pacote Flutter & cloud\_firestore & 0.16.0 & 04  & - \\ \midrule
Todos & Dependência Android & google-services & 4.3.5 & 04  & - \\ \midrule
Todos & Dependência Android & firebase-bom & 26.5.0 & 04  & - \\ \midrule
Todos & Ferramenta de compilação & gradle & 4.1.2 & 04  & - \\ \bottomrule
\end{tabular}%
\end{table}
...
\begin{tabular}{@{}ll@{}}
\toprule
Temas de investimentos & Descrição \\ \midrule
IT01 & Entregar ao usuário o controle de suas anotações \\ \bottomrule
\end{tabular}%
}{%\fonte{}%
}
\end{table}
...
\begin{tabular}{@{}ll@{}}
\toprule
Épicos & Descrição \\ \midrule
EP01 & Permitir que usuário crie anotações, exporte notas e atribua etiquetas \\ \bottomrule
\end{tabular}%
}{%\fonte{}%
}
\end{table}
...
EP01 & FT01 & Serviço de backup em nuvem \\ \midrule
EP01 & FT02 & Serviço de backup local \\ \midrule
EP01 & FT03 & Gerência de anotações \\ \midrule
EP01 & FT04 & Inclusão de ferramentas básicas de gestão de tempo \\ \bottomrule
\end{tabular}%
}{%\fonte{}%
}
\end{table}
...
As histórias de usuário (tabela \ref{tab:historias_de_usuario}) são derivadas a partir das \foreignlanguage{english}{\textit{features}} e estão presentes nos \foreignlanguage{english}{\textit{backlogs}} da equipe, de onde são retirados para serem colocados nos quadros \textit{kanban} de cada equipe ágil.

\IBGEtabfontsize
\begin{longtable}{@{}p{0.1\textwidth}p{0.05\textwidth}p{0.29\textwidth}p{0.49\textwidth}@{}}
\caption{Histórias de usuário}
\label{tab:historias_de_usuario} \\
\toprule
\textbf{Feature} & \textbf{ID} & \textbf{Nome} & \textbf{Descrição} \\ \midrule
FT01 & US10 & Criar conta & Eu como usuário desejo criar conta para utilizar o armazenamento remoto \\ \midrule
FT01 & US11 & Configurar preferências de armazenamento e backup & Eu como usuário desejo configurar preferências de armazenamento e backup para salvar minhas anotações remotamente e localmente ou apenas localmente \\ \midrule
FT01 & US12 & Sincronizar anotações locais com armazenamento remoto (nuvem) & Eu como usuário desejo sincronizar anotações locais com armazenamento remoto (nuvem) para não perder minhas anotações em caso de roubo \\ \midrule
FT02 & US09 & Exportar anotações em armazenamento local em texto puro & Eu como usuário desejo exportar anotações em armazenamento local em texto puro para compartilhar por outras plataformas a cópia das anotações \\ \midrule
FT02 & US20 & Exportar anotações locais em JSON & Eu como usuário desejo exportar anotações locais no formato JSON para que seja utilizada em outras aplicações \\ \midrule
FT03 & US01 & Criar anotações & Eu como usuário desejo criar anotações para lembrar de conteúdos que me interessem \\ \midrule
FT03 & US02 & Salvar anotações & Eu como usuário desejo salvar anotações para poder consultar seus conteúdos posteriormente \\ \midrule
FT03 & US03 & Visualizar anotações & Eu como usuário desejo visualizar anotações para visualizar os lembretes que já foram criados \\ \midrule
FT03 & US04 & Editar anotações & Eu como usuário desejo editar anotações para que possa alterar seus conteúdos sem que seja necessário reescrevê-los completamente \\ \midrule
FT03]& US05 & Deletar anotações & Eu como usuário desejo deletar anotações para remover conteúdos que não são mais necessários \\ \midrule
FT03 & US06 & Etiquetar anotações & Eu como usuário desejo etiquetar anotações para organizá-las \\ \midrule
FT03 & US07 & Consultar anotações por etiquetas & Eu como usuário desejo consultar anotações por etiquetas para visualizar apenas as anotações com as etiquetadas selecionadas \\ \midrule
FT03 & US13 & Criar anotações do tipo lista & Eu como usuário desejo criar anotações do tipo lista para organizar mais facilmente minhas tarefas e saber quais restam ser feitas \\ \midrule
FT03 & US14 & Consultar anotações por conteúdo & Eu como usuário desejo consultar anotações por conteúdo para facilmente acessar algo que preciso lembrar \\ \midrule
FT03 & US15 & Arquivar anotações & Eu como usuário desejo arquivar anotações para não deixar visível sem exclui-la \\ \midrule
...
FT03 & US18 & Compartilhar anotações com outros aplicativos em formato texto & Eu como usuário desejo compartilhar anotações em formato texto para pode utilizar em outros aplicativos \\ \midrule
FT03 & US21 & Relatório do tempo de execução de tarefas e notas temporizadas & Eu como usuário desejo criar relatório do tempo de execução de tarefas e anotações temporizadas para poder visualizar o tempo gasto \\ \midrule
FT04 & US08 & Verificar tempo de duração de uma anotação & Eu como usuário desejo verificar o tempo de duração de uma anotação para visualizar o tempo de inicio e fim anotação \\ \midrule
FT04 & US16 & Configurar alarmes & Eu como usuário desejo configurar lembretes nas anotações para poder ser alertado por eles \\ \midrule
FT04 & US19 & Cronometrar tempo de execução de tarefas em listas & Eu como usuário desejo cronometrar tempo de execução de tarefas listadas em uma anotação para saber o tempo gasto \\ \bottomrule
\end{longtable}
...
NFR01 & Compatibilidade com Android 7 a 11 \\ \bottomrule
\end{tabular}%
}{%\fonte{}%
}
\end{table}
